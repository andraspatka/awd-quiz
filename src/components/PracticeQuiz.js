                ...
                <div className='studyContainer'>
                    ...
                    <div className='messageDiv'>
                        {answer
                            ...
                            : <h1 className='wrongAnswer'>Incorrect answer!</h1>}
                        ...
                        {index + 1 === numberOfQuestions
                            ? <button onClick={this.nextQuestion}>Check results</button>
                    ...
                    <div>
                        <h1 className='scoreMessage'>
                            You've answered {score}/{numberOfQuestions} questions correctly. <br/>
                            {percentage > 0.75 ? 'Nice work!' : 'Keep studying and try again!'}
                        </h1>
                    ...
                    {!isMobile && <div id='infoBox'>
                        <p>Use <i className='fa fa-long-arrow-up'/> <i className='fa fa-long-arrow-down'/> for navigation<br/>
                        Space: for selecting a question<br/>
                        Escape: for quiting the quiz
                        </p>
                    </div>}
