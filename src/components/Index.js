...
const renderHeader = (isDesktop) => (
    <div className='header'>
        <span>Adaptive Web Design quiz!</span>
    </div>
);
                    ...
                    <div className='studyComponent'>
                            ...
                            return (
                                <div key={title} className='quizContainer'>
                                    ...
                                    <Link to={`/practice/${title}`} className={renderClassName(index)}
                                        ...
                                        {quiz.get("title")} <span>({challenges.size} {challenges.size > 1 ? 'questions': 'question'})</span>
                                    </Link>
                                </div>
                            )
                        })}
                        <div className='quizContainer'>
                            <Link to='practice/shuffle' className={renderClassName(maxOptions - 1)}
                                  onMouseEnter={this.onHover}>
                                Quiz created from all categories <span>({totalQuestions} questions)</span>
                            </Link>
                        </div>
                        <div className='quizContainer'>
